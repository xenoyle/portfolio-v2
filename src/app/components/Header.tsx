...
export default function Header() {
  return (
    <header className="fixed top-0 z-50 items-center px-8 py-5 bg-background shadow-accent shadow-2xl w-full border-t-3 border-b-3 border-accent justify-center flex flex-row gap-20">
